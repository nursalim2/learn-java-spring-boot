...
public class RestTemplateTest {
    ...
    void testAddTodo() {
        ...
        form.add("todo", "Learn Spring Web MVC");
        ...
        Assertions.assertEquals("Learn Spring Web MVC", response.getBody().get(0));
    }
    ...
    void testGetTodo() {
        ...
        Assertions.assertEquals(HttpStatus.OK, response.getStatusCode());
        Assertions.assertTrue(response.getBody().contains("Learn Spring Web MVC"));
    }
}
